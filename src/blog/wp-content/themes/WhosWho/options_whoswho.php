	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Purple", "Green", "Red")),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Category Boxes",
                   "id" => $shortname."_show_catboxes",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc."),
			...
			array( "name" => "Display Popular Articles",
                   "id" => $shortname."_show_popular",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "Here you can choose to display Popular Articles. "),

			array( "name" => "Display Recent Comments",
                   "id" => $shortname."_show_recentcomments",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => "Here you can choose to display Recent Comments. "),
			...
			array( "name" => "Category Box 1",
                   "id" => $shortname."_home_cat_one",
                   "type" => "select",
                   "et_array_for" => "categories",
			       "options" => $site_cats,
				   "desc" => "Choose a category below. "),

			array( "name" => "Category Box 2",
			...
			array( "name" => "Number of Random Articles",
                   "id" => $shortname."_random_num",
                   "std" => "10",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Choose the number of posts you would like to display. "),

			array( "name" => "Number of Popular Articles",
                   "id" => $shortname."_popular_num",
                   "std" => "6",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Choose the number of posts you would like to display. "),

			array( "name" => "Number of Recent Comments",
			...
			array( "name" => "Exclude categories from homepage recent posts",
			 ...
			 array( "name" => "Post info section (Default mode)",
			   "id" => $shortname."_postinfo_homedefault",
		...
		array( "name" => "general-3",
			...
			array( "name" => "Display Featured Article",
			...
			array( "name" => "Duplicate Featured Article",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Show the share button",
            "id" => $shortname."_show_share",
            "type" => "checkbox",
            "std" => "on",
			"desc" => "Here you can choose to display the Share button. "),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable 468x60 Single Post banner",
			...
			array( "name" => "Input 468x60 Single Post advertisement banner image",
			...
			array( "name" => "Input 468x60 Single Post advertisement destination url",
				   "id" => $shortname."_468_url",
				   "type" => "text",
				   "validation_type" => "url",
				   "std" => "",
				   "desc" => "Place the destination URL below. ",),

			array( "name" => "Input 468x60 Single Post adsense code",
